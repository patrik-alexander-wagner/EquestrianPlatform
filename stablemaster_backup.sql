...
--
-- Name: idx_invoices_customer_billing_month; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_invoices_customer_billing_month ON public.invoices USING btree (customer_id, billing_month);
